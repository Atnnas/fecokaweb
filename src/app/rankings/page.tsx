                ...
                <table className="w-full text-left min-w-[800px]">
                    <thead>
                        <tr className="bg-midnight-blue text-white">
                            <th className="px-10 py-8 font-black text-xs uppercase tracking-[0.3em]">Pos</th>
                            <th className="px-10 py-8 font-black text-xs uppercase tracking-[0.3em]">Atleta</th>
                            <th className="px-10 py-8 font-black text-xs uppercase tracking-[0.3em]">Categoría</th>
                            <th className="px-10 py-8 font-black text-xs uppercase tracking-[0.3em]">Dojo / Club</th>
                            <th className="px-10 py-8 font-black text-xs uppercase tracking-[0.3em] text-right">Puntaje</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-silver-accent">
                        {filteredRankings.length > 0 ? filteredRankings.map((athlete: any) => (
                            <tr key={athlete._id} className="hover:bg-midnight-blue/[0.02] transition-colors group">
                                ...
                                <td className="px-10 py-10 text-steel-gray font-bold text-sm">
                                    {athlete.dojo}
                                </td>
