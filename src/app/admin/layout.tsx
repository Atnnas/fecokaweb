...
export default async function AdminLayout({
    ...
    return (
        <div className="flex flex-col md:flex-row h-[100dvh] bg-mist-white overflow-hidden text-deep-black font-sans">
            <AdminSidebar />
            <main className="flex-1 relative overflow-y-auto overflow-x-hidden custom-scrollbar">
                <div className="py-6 md:py-12 px-6 md:px-12 lg:px-20 w-full min-h-full flex flex-col">
                    {children}
                </div>
            </main>
        </div>
